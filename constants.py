...
POSIZIONE = {"Comune del progetto":["BasiDati","Comune","id_com"], "Elementi lineari":["GeoTec","Elineari","ID_el"], "Elementi puntuali":["GeoTec","Epuntuali","ID_ep"],
             ...
             "Isobate liv 3":["MS23","Isosub","ID_isosub"], "Infrastrutture di accessibilita' e connessione":["CLE","CL_AC","ID_AC"], "Aree di emergenza":["CLE","CL_AE","ID_AE"],
...
LISTA_LAYER = ["Siti puntuali", "Indagini puntuali", "Parametri puntuali", "Curve di riferimento", "Siti lineari", "Indagini lineari", "Parametri lineari",
               ...
               "Comune del progetto", "Limiti comunali", "Infrastrutture di accessibilita' e connessione", "Aree di emergenza", "Aggregati strutturali", "Edifici strategici", "Unita' strutturali"]
