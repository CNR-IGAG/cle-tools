...
class valida(QtGui.QDialog, FORM_CLASS):
	...
	def controllo(self):
		...
		"Infrastrutture di accessibilita' e connessione":{},
		"Aree di emergenza":{},
		"Aggregati strutturali":{},
		"Edifici strategici":{},
		"Unita' strutturali":{}}
		SHP_VALIDATORE = ["geotec_self_inters", "stab_1_self_inters", "instab_1_self_inters", "ms1_inters_stab_instab", "stab_2_self_inters", "instab_2_self_inters", "ms2_inters_stab_instab", "stab_3_self_inters", "instab_3_self_inters", "ms3_inters_stab_instab", "ae_self_inters", "as_self_inters", "es_self_inters", "us_self_inters", "inters_ae_as", "inters_ae_es", "inters_ae_us", "inters_as_es", "inters_es_us"]
		...
		if result:
			...
			try:
				...
				if "Infrastrutture di accessibilita' e connessione" in added or "Aree di emergenza" in added or "Aggregati strutturali" in added or "Edifici strategici" in added or "Unita' strutturali" in added:
					intersezioni_cle = False
				...
				e.write("   I am performing topological validation of 'Unita' geologico-tecniche' level...\n")
				if intersezioni_geotec is True:
					self.autointersect(pathname + os.sep + "analisi", "Unita' geologico-tecniche", "ID_gt", "geotec_self_inters", e)
...
##					e.write("	Done! File containing auto-intersections of 'Unita' geologico-tecniche' layer has been saved in '\\allegati\\log\\analisi\\geotec_self_inters.shp'\n\n")
				...
				if intersezioni_ms1 is True:
					self.autointersect(pathname + os.sep + "analisi", "Zone stabili liv 1", "ID_z", "stab_1_self_inters", e)
					self.autointersect(pathname + os.sep + "analisi", "Zone instabili liv 1", "ID_i", "instab_1_self_inters", e)
##					self.topology_check(pathname + os.sep + "analisi", "Zone stabili liv 1", "Zone instabili liv 1", "ID_z", "ID_i", "stab_1_self_inters", "instab_1_self_inters", "ms1_inters_stab_instab", e)
					self.topology_check(pathname + os.sep + "analisi", "Zone stabili liv 1", "Zone instabili liv 1", "ID_z", "ID_i", "ms1_inters_stab_instab", e)
				else:
					e.write("	Topological validation can not be performed because one or more layers is/are missing!\n\n")

				e.write("   I am performing topological validation of the 'MS2' level...\n")
				if intersezioni_ms2 is True:
					self.autointersect(pathname + os.sep + "analisi", "Zone stabili liv 2", "ID_z", "stab_2_self_inters", e)
					self.autointersect(pathname + os.sep + "analisi", "Zone instabili liv 2", "ID_i", "instab_2_self_inters", e)
##					self.topology_check(pathname + os.sep + "analisi", "Zone stabili liv 2", "Zone instabili liv 2", "ID_z", "ID_i", "stab_2_self_inters", "instab_2_self_inters", "ms2_inters_stab_instab", e)
					self.topology_check(pathname + os.sep + "analisi", "Zone stabili liv 2", "Zone instabili liv 2", "ID_z", "ID_i", "ms2_inters_stab_instab", e)
				else:
					e.write("	Topological validation can not be performed because one or more layers is/are missing!\n\n")

				e.write("   I am performing topological validation of the 'MS3' level...\n")
				if intersezioni_ms3 is True:
					self.autointersect(pathname + os.sep + "analisi", "Zone stabili liv 3", "ID_z", "stab_3_self_inters", e)
					self.autointersect(pathname + os.sep + "analisi", "Zone instabili liv 3", "ID_i", "instab_3_self_inters", e)
##					self.topology_check(pathname + os.sep + "analisi", "Zone stabili liv 3", "Zone instabili liv 3", "ID_z", "ID_i", "stab_3_self_inters", "instab_3_self_inters", "ms3_inters_stab_instab", e)
					self.topology_check(pathname + os.sep + "analisi", "Zone stabili liv 3", "Zone instabili liv 3", "ID_z", "ID_i", "ms3_inters_stab_instab", e)
				else:
					e.write("	Topological validation can not be performed because one or more layers is/are missing!\n\n")

				e.write("   I am performing topological validation of the 'CLE' level...\n")
				if intersezioni_cle is True:
					self.autointersect(pathname + os.sep + "analisi", "Aree di emergenza", "ID_AE", "ae_self_inters", e)
					self.autointersect(pathname + os.sep + "analisi", "Aggregati strutturali", "ID_AS", "as_self_inters", e)
					self.autointersect(pathname + os.sep + "analisi", "Edifici strategici", "ID_ES", "es_self_inters", e)
					self.autointersect(pathname + os.sep + "analisi", "Unita' strutturali", "ID_US", "us_self_inters", e)
					self.topology_check(pathname + os.sep + "analisi", "Aree di emergenza", "Aggregati strutturali", "ID_AE", "ID_AS", "inters_ae_as", e)
					self.topology_check(pathname + os.sep + "analisi", "Aree di emergenza", "Edifici strategici", "ID_AE", "ID_ES", "inters_ae_es", e)
					self.topology_check(pathname + os.sep + "analisi", "Aree di emergenza", "Unita' strutturali", "ID_AE", "ID_US", "inters_ae_us", e)
					self.topology_check(pathname + os.sep + "analisi", "Aggregati strutturali", "Edifici strategici", "ID_AS", "ID_ES", "inters_as_es", e)
					self.topology_check(pathname + os.sep + "analisi", "Edifici strategici", "Unita' strutturali", "ID_ES", "ID_US", "inters_es_us", e)
				else:
					e.write("	Topological validation can not be performed because one or more layers is/are missing!\n\n")
	...
	def autointersect(self, directory, lyr, campo, nome, e):
		processing.runandload("saga:polygonselfintersection", lyr, campo, directory + os.sep + nome + ".shp")
		self.elab_self_intersect(nome)
		self.remove_record(nome)
		e.write("	Done! File containing auto-intersections of '" + lyr + "' layer has been saved in '\\allegati\\log\\analisi\\" + nome + ".shp'\n")

	def topology_check(self, directory, lyr1, lyr2, campo1, campo2, nome3, e):
...
##		e.write("	Done! File containing auto-intersections of '" + lyr2 + "' layer has been saved in '\\allegati\\log\\analisi\\" + nome2 + ".shp'\n")
	...
	def elab_intersect(self, nome_file_inters):
		...
		fieldnames = set(['ID_z', 'ID_i', 'ID_AE', 'ID_AS', 'ID_ES', 'ID_US'])
