# -*- coding: utf-8 -*-
#
# CLETools documentation build configuration file, created by
...
project = u'CLETools'
copyright = u'2021, CNR-IGAG LabGIS'
...
latex_documents = [
  ('index', 'CLETools.tex', u'CLETools - Manuale d\'uso',
   u'CNR-IGAG LabGIS', 'manual'),
]
...
man_pages = [
    ('index', 'TemplateClass', u'CLETools Documentation',
     [u'CNR-IGAG LabGIS'], 1)
]
